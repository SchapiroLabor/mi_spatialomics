...
endocardial_cells_dotplot <- DotPlot(new_seurat_object, 
  ...
  guides(size=guide_legend(override.aes=list(shape=21, colour="black", fill="black"))) + theme(plot.tag = element_text(size = 20, face = "bold"))
...
save_plot(endocardial_cells_dotplot,
          file = "./plots/molkart.endocardial_dotplot.pdf",
          base_height = 4)
```
