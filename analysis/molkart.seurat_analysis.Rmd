...
## Transfer labels from snRNA-seq (Calcagno et al. 2022)

To get some labels for cell types from a publicly available dataset, we will transfer labels from an snRNA-seq dataset generated by [Calcagno et al. 2022 in Nature cardiovascular research](https://www.nature.com/articles/s44161-022-00160-3).
