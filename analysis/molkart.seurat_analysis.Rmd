...
new.cluster.ids <- c("Cardiomyocytes",  #0
                     ...
                     "Immune_cells", #8
                     "Endothelial_cells", #9 -> Between nCMs and endo?
                     "Immune_cells", #10
                     "Pericytes" , #11
                     "Cardiomyocytes", #12
...
new.cluster.ids <- c("Cardiomyocytes",  #0
                     ...
                     "Myeloid_cells_1", #8
                     "EndMA+", #9
                     "Myeloid_cells_2", #10 Dendritic cells
                     "Pericytes" , #11
...
new.cluster.ids <-  c("Cardiomyocytes_Pln",  #0
                     ...
                     "Cardiomyocytes_Nppa+", #5 Macrophages
                     "Cardiomyocytes_Clu", #6
                     "Cardiac_fibroblasts_Dcn", #7
                     "Myeloid_cells_1_C1qa", #8
                     "EndMA+_Fn1", #9
                     "Myeloid_cells_2_Cd74", #10 Dendritic cells
                     "Pericytes_Colec11" , #11
                     "Cardiomyocytes_Nppb+", #12
                     "Smooth_muscle_cells_Myh11", #13
                     "Cardiomyocytes_Vegfa", #14
                     "Endocardial_cells_Npr3", #15
                     "Myeloid_cells_3_Csf3r", #16
                     "Cardiomyocytes_Nppa+",#17
                     "Cardiomyocytes", #18
                     "Myeloid_cells_4_Ccl2", #19
                     "Cardiomyocytes_Nppa+", #20
                     "Cardiac_fibroblasts_Col1a1", #21
                     "Myeloid_cells_5_C1qa", #22
...
harmony_object@meta.data <- harmony_object@meta.data %>%
  mutate("anno_cell_type_lvl2" = if_else(spatial_endoc == TRUE & anno_cell_type_lvl2 == "Endocardial_cells","Endocardial_cells",
         ...
         "anno_cell_type_lvl3" = if_else(spatial_endoc == TRUE & anno_cell_type_lvl3 == "Endocardial_cells_Npr3","Endocardial_cells_Npr3",
                                         ...
                                         if_else(spatial_endoc == FALSE & anno_cell_type_lvl3 == "Endocardial_cells_Npr3","Endothelial_cells",anno_cell_type_lvl3))))
...
```{r}
misty_in <- misty_in %>%
  mutate("misty_cts" = if_else(grepl("Myeloid_cells",anno_cell_type_lvl2),"Myeloid_cells",anno_cell_type_lvl2))
...
for(cluster_of_int in unique(harmony_object$anno_cell_type_lvl2)){
  ...
  filename <- paste("./output/molkart/molkart_cell_types/",cluster_of_int,".cell_type_distributions.png",sep = "")
  save_plot(time_plot,
            filename = filename,
            base_height = 6)
}
