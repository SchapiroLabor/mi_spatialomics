...
immune_barplot <- ggplot(immune_cells,aes(timepoint,count_per_mm2)) +
  ...
  labs(x = "Timepoint", y = "count_per_mm2")

save_plot(filename = "./plots/supp_figure_X.immune_cells_regions.pdf",
          plot = immune_barplot,
          base_asp = 2,
          base_height = 8)
...
save_plot(filename = "./plots/supp_figure_X.NONimmune_cells_regions.pdf",
