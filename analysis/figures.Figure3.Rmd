...
save_plot(filename = "./figures/Figure_3.tradIF-absolute_cell_counts.pdf",
          plot = abs_plot,
          base_asp = 1.8,
          base_height = 3)
```
...
```{r}
# ggplot(abs_counts,aes(region,cell_count)) +
#     stat_summary(
#       fun.y = mean,
#       geom = "bar",
#       width = 0.9,
...
#       fill = "lightgrey") +
#     labs(x = "",
#          y = "Absolute cell number") +
#   geom_beeswarm(size = 3.5, pch = 21, color = "black", aes(fill = timepoint)) +
